...
public class Assets {
	...
	public static void init() {
		...
		// player attack
		for (int i = 0; i < 9; i++) {
			player_attackDown[i] = playerAttack.crop(96 * i, 96 * 5, 96, 96);
			player_attackUp[i] = playerAttack.crop(96 * i, 96 * 3, 96, 96);
			player_attackLeft[i] = playerAttack.crop(96 * i, 96 * 0, 96, 96);
			player_attackRight[i] = playerAttack.crop(96 * i, 96 * 2, 96, 96);
		}
