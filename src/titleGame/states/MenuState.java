...
public class MenuState extends State {
	...
	public MenuState(Handler handler) {
		...
		uiManager.addObject(new UIImageButton(500, 100, 300, 70, Assets.btn_easy, new ClickListener() {
		...
		uiManager.addObject(new UIImageButton(500, 200, 300, 70, Assets.btn_hard, new ClickListener() {
